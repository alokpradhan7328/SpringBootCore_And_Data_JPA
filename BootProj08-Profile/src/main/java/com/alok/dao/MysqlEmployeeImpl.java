...
@Profile({"dev","test"})
public class MysqlEmployeeImpl implements IEmployeeDAO 
{

	private final String GET_EMPS_QUERY = "SELECT ENO,ENAME,SAL,DEPTNO,JOB FROM EMPLOYEE WHERE JOB IN (?,?,?) ORDER BY DEPTNO";
